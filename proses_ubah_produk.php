...
if($_POST){
    ...
    if(empty($nama_produk)){
        echo "<script>alert('nama petugas tidak boleh kosong');location.href='ubah_produk.php';</script>";
        ...
        if(empty($nama_produk)){
            ...
            if($update){
                echo "<script>alert('Sukses update produk');location.href='ubah_produk.php';</script>";
            } else {
